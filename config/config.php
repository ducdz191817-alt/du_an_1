...
if (!defined('BASE_URL')) {
    define('BASE_URL', 'http://localhost/du_an_1n/'); // URL cơ bản của dự án(Lưu ý cấp độ trong htdocs hoặc www)
}
...
return [
    'db' => [
        ...
        'name' => 'qltour', // Tên cơ sở dữ liệu (phải khớp với database trong tour.sql)
