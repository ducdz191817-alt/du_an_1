        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    Sửa Tour: <?= htmlspecialchars($tour['name']) ?>
                </h3>
            </div>
            <div class="card-body">
                <?php if (!empty($errors)): ?>
                ...
                <form method="POST" action="<?= BASE_URL ?>?act=tours/update" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="start_date" 
                                           value="<?= date('Y-m-d', strtotime($tour['start_date'])) ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="end_date" class="form-label required">Ngày kết thúc</label>
                                    <input type="date" class="form-control" id="end_date" name="end_date" 
                                           value="<?= date('Y-m-d', strtotime($tour['end_date'])) ?>" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status_id" name="status_id">
                                    <option value="1" <?= ($tour['status_id'] == 1) ? 'selected' : '' ?>>Chờ xác nhận</option>
                                    <option value="2" <?= ($tour['status_id'] == 2) ? 'selected' : '' ?>>Đã xác nhận</option>
                                    <option value="3" <?= ($tour['status_id'] == 3) ? 'selected' : '' ?>>Đang diễn ra</option>
                                    <option value="4" <?= ($tour['status_id'] == 4) ? 'selected' : '' ?>>Đã hoàn thành</option>
                                    <option value="5" <?= ($tour['status_id'] == 5) ? 'selected' : '' ?>>Đã hủy</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="schedule_detail" name="schedule_detail" 
                                          rows="3"><?= htmlspecialchars($tour['schedule_detail']) ?></textarea>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="<?= BASE_URL ?>?act=tours/show&id=<?= $tour['id'] ?>" class="btn btn-info">
